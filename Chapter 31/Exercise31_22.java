 ...
 * <h1>Exercise31_22</h1>
 *
 * <p>This class is a modified version of AddNewRowDemo that allows for the deletion
 * of a selected row from the GUI. This includes the ones that are placed automatically
 * not just the ones that the user inputs into the table.</p>
 *
 * <p>Created: Unknown   Edited: 01/13/2022</p>
 *
...
public class Exercise31_22 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        btDeleteRow.setOnAction(e ->{ //If delete row button is selected
            //Delete the selected row if one is selected
        ...
        primaryStage.setTitle("Exercise31_22"); // Set the window title
     ...
     * <h1>Country</h1>
     *
     * <p>This class is a constructor for the country objects.</p>
     *
     * <p>Created: Unknown</p>
     *
     * @author Unknown
